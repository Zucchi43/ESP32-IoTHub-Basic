...
static void generateTelemetryPayload() {
  ...
  telemetry_payload = "{\"Temperature\":" + String(temp.temperature) + ",\"Acelerometer_X\":" + String(a.acceleration.x) + ",\"Acelerometer_Y\":" + String(a.acceleration.y) + ",\"Acelerometer_Z\":" + String(a.acceleration.z) + ",\"Gyroscope_X\":" + String(g.gyro.x) + ",\"Gyroscope_Y\":" + String(g.gyro.y) + ",\"Gyroscope_Z\":" + String(g.gyro.z) + " }";
}
